...
include "fyp/conn.php";
$ib=$_GET['id'];
$qry7=$con->query("SELECT* from budget where id='$id' AND budget_id='$ib' order by budget_id desc");
...
while($row=$qry7->fetch_assoc()):
	...
	$name = $row['Budget_name'];
	?>
	<h2 style="color: #073d80; font-size: 30px; margin-left:280px;"><?php echo $row['Budget_name']; ?></h2>

	<table class="table table-bordered table-hover"style=" allign-item:center;">

	<thead>
		<tr>
		<!-- <th><button class="button" id="print" >Report</button></th> -->
		<th>s/n</th>
		<th>category</th>
		<th>name</th>
		<th>amount</th>
						...
						<button class="button" id="print" style="background-color: green; font-size: 20px; margin-left:450px; width: 200px;"  >Report</button>
	</div>
	<script>
